    ...
    return (
        <HashRouter>
            <Switch>
                ...
                <RotaAutenticada isUsuarioAutenticado={props.isUsuarioAutenticado} path="/funcionarios" component={Funcionario} />
                <RotaAutenticada isUsuarioAutenticado={props.isUsuarioAutenticado} path="/cadastro-funcionario" component={CadastroFuncionario} />
